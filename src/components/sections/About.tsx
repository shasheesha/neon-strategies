...
const About: React.FC = () => {
    ...
    return(
        <>
            <section className="pt-10 pb-10 lg:pt-40 lg:pb-20">
                ...
                <div className="px-10 lg:px-20">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-1 mb-10 sm:mb-28">
                      ...
                      <div className="lg:col-span-2">
                        ...
                        <div className="">
                          <CustomButton btnName={"Contact Us Today"} withArrow={true} classNames={"py-2 px-4 md:py-3 md:px-5 lg:py-4 lg:px-6 xl:py-4 xl:px-7 text-base md:text-lg lg:text-xl text-white bg-blue border-2 border-blue hover:bg-white hover:text-blue"} />
                        </div>
                      </div>
                    </div>
                </div>
