                ...
                <div className="px-5 md:px-10 lx:px-20 mb-20 grid grid-cols-1 lg:grid-cols-2 gap-10">
                    <div className="flex flex-col justify-start">
                        ...
                        <form action="contact-form" onSubmit={handleSubmit(send)}>
                            ...
                            <CustomButton btnName={"Submit"} submit={true} classNames="px-6 py-2 lg:px-8 lg:py-2 xl:px-10 xl:py-3 bg-blue text-white min-w-32 md:min-w-56 xl:min-w-64 border-2 border-blue hover:bg-white hover:text-blue hover:font-semibold" />
                        </form>
                    </div>
