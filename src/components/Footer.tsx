            ...
            <div className="container mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 my-11 px-5 lg:px-0">
                    <div>
                        ...
                        <div className="flex flex-col sm:flex-row justify-start gap-3 md:gap-5 lg:gap-10">
                            <p className="font-normal text-grayone leading-normal text-base md:text-lg lg:text-xl">Neon Strategies Ltd.<br />123 Marketing Street,<br />London, W1A 1AA<br />United Kingdom</p>
                            <p className="font-normal text-grayone leading-normal text-base md:text-lg lg:text-xl">Monday - Friday: 9:00 AM - 6:00 PM</p>                        
                        </div>
                    </div>
